...
function RoomUpdate(){
    ...
    const handleInputChange = (
        ...
        const id = event.target.id as keyof typeof rooms;
                        ...
                        <Grid container spacing={3} sx={{ padding: 2 }}>
                            ...
                            <Grid item xs={6}>
                                <FormControl fullWidth variant="outlined" className="flex items-center justify-center">
                                    <img src={`${rooms.Illustration}`}  alt="old-image" className="md:w-4/6 h-auto filter grayscale"/>
                                </FormControl>
                            </Grid>
                            <Grid item xs={6}>
                                <FormControl fullWidth variant="outlined" className="flex items-center justify-center">
                                    <img src={`${image}`}  alt="new-image" className="md:w-4/6 h-auto"/>
                                </FormControl>
                            </Grid>
                            ...
                            <Grid item xs={12}>
                                <Button style={{ float: "left" }}
                                    component={RouterLink} to="/room-mannage"
                                    variant="contained"
                                    color="inherit"
                                    >Quit
                                </Button>
                                <Button style={{ float: "right" }}
                                    onClick={() => submitForUpdate(rooms)}
                                    variant="contained"
                                    color="success"
                                    >Submit
                                </Button>
